  ...
  private
    ...
    def projekt_params
      attributes = [
        ...
        comment_phase_attributes: [:id, :start_date, :end_date, :verification_restricted, :geozone_restricted,
                                   :active, geozone_restriction_ids: []],
        debate_phase_attributes: [:id, :start_date, :end_date, :verification_restricted, :geozone_restricted,
                                  :active, geozone_restriction_ids: []],
        proposal_phase_attributes: [:id, :start_date, :end_date, :verification_restricted, :geozone_restricted,
                                    :active, geozone_restriction_ids: []],
        question_phase_attributes: [:id, :start_date, :end_date, :verification_restricted, :geozone_restricted,
                                    :active, geozone_restriction_ids: []],
        voting_phase_attributes: [:id, :start_date, :end_date, :verification_restricted, :geozone_restricted,
                                  :active, geozone_restriction_ids: []],
        budget_phase_attributes: [:id, :start_date, :end_date, :verification_restricted, :geozone_restricted,
                                  :active, geozone_restriction_ids: []],
        legislation_phase_attributes: [:id, :start_date, :end_date, :verification_restricted, :geozone_restricted,
                                       :active, geozone_restriction_ids: []],
        ...
        livestream_phase_attributes: [:id, :start_date, :end_date, :verification_restricted, :geozone_restricted,
                                    :active, geozone_restriction_ids: []],
