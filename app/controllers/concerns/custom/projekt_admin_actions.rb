  ...
  private
    ...
    def projekt_params
      attributes = [
        ...
        comment_phase_attributes: [:id, :active, :start_date, :end_date,
                                   :verification_restricted,
                                   :age_restricted, :age_restriction_id,
                                   :geozone_restricted,
                                   geozone_restriction_ids: []],
        debate_phase_attributes: [:id, :active, :start_date, :end_date,
                                  :verification_restricted,
                                  :age_restricted, :age_restriction_id,
                                  :geozone_restricted,
                                  geozone_restriction_ids: []],
        proposal_phase_attributes: [:id, :active, :start_date, :end_date,
                                    :verification_restricted,
                                    :age_restricted, :age_restriction_id,
                                    :geozone_restricted,
                                    geozone_restriction_ids: []],
        question_phase_attributes: [:id, :active, :start_date, :end_date,
                                    :verification_restricted,
                                    :age_restricted, :age_restriction_id,
                                    :geozone_restricted,
                                    geozone_restriction_ids: []],
        voting_phase_attributes: [:id, :active, :start_date, :end_date,
                                  :verification_restricted,
                                  :age_restricted, :age_restriction_id,
                                  :geozone_restricted,
                                  geozone_restriction_ids: []],
        budget_phase_attributes: [:id, :active, :start_date, :end_date,
                                  :verification_restricted,
                                  :age_restricted, :age_restriction_id,
                                  :geozone_restricted,
                                  geozone_restriction_ids: []],
        legislation_phase_attributes: [:id, :active, :start_date, :end_date,
                                       :verification_restricted,
                                       :age_restricted, :age_restriction_id,
                                       :geozone_restricted,
                                       geozone_restriction_ids: []],
        argument_phase_attributes: [:id, :active, :start_date, :end_date],
        projekt_notification_phase_attributes: [:id, :active, :start_date, :end_date],
        milestone_phase_attributes: [:id, :active, :start_date, :end_date],
        event_phase_attributes: [:id, :active, :start_date, :end_date],
        livestream_phase_attributes: [:id, :active, :start_date, :end_date,
                                      :verification_restricted,
                                      :age_restricted, :age_restriction_id,
                                      :geozone_restricted,
                                      geozone_restriction_ids: []],
        newsfeed_phase_attributes: [:id, :active, :start_date, :end_date],
