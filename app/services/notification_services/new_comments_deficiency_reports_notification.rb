module NotificationServices
  class NewCommentsDeficiencyReportsNotification < ApplicationService
    ...
    def send_new_comments_email(deficiency_report)
      new_comments = deficiency_report.comments.where("created_at > ?", deficiency_report.notified_officer_about_new_comments_datetime)
      last_notified_time = deficiency_report.notified_officer_about_new_comments_datetime

      deficiency_report.update(notified_officer_about_new_comments_datetime: Time.now)
