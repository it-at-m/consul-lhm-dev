define(['./defaultValue-0a909f67', './Matrix3-315394f6', './ArcType-ce2e50ab', './arrayRemoveDuplicates-c2038105', './Transforms-40229881', './Color-a84038cb', './ComponentDatatype-f7b11d02', './Check-666ab1a0', './GeometryAttribute-7d6f1732', './GeometryAttributes-f06a2792', './IndexDatatype-a55ceaa1', './Math-2dbd6b93', './PolylinePipeline-32f36d2a', './VertexFormat-6b480673', './Matrix2-13178034', './RuntimeError-06c93819', './combine-ca22a614', './WebGLConstants-a8cc3e8c', './EllipsoidGeodesic-98c62a56', './EllipsoidRhumbLine-19756602', './IntersectionTests-f6e6bd8a', './Plane-900aa728'], function (defaultValue, Matrix3, ArcType, arrayRemoveDuplicates, Transforms, Color, ComponentDatatype, Check, GeometryAttribute, GeometryAttributes, IndexDatatype, Math$1, PolylinePipeline, VertexFormat, Matrix2, RuntimeError, combine, WebGLConstants, EllipsoidGeodesic, EllipsoidRhumbLine, IntersectionTests, Plane) {
  ...
  function PolylineGeometry(options) {
    ...
    if (defaultValue.defined(colors) && (colorsPerVertex && colors.length < positions.length || !colorsPerVertex && colors.length < positions.length - 1)) {
  ...
  var scratchPrevPosition = new Matrix3.Cartesian3();
  var scratchNextPosition = new Matrix3.Cartesian3();
  ...
  PolylineGeometry.createGeometry = function (polylineGeometry) {
    ...
    var k;
    var removedIndices = [];
    var positions = arrayRemoveDuplicates.arrayRemoveDuplicates(polylineGeometry._positions, Matrix3.Cartesian3.equalsEpsilon, false, removedIndices);
    ...
    var finalColors = defaultValue.defined(colors) ? new Uint8Array(size * 4) : undefined;
    var positionIndex = 0;
    ...
    for (j = 0; j < positionsLength; ++j) {
      ...
      if (j === positionsLength - 1) {
        position = scratchCartesian3;
        Matrix3.Cartesian3.subtract(positions[positionsLength - 1], positions[positionsLength - 2], position);
