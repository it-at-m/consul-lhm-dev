define(['exports', './Matrix3-315394f6', './Check-666ab1a0', './defaultValue-0a909f67', './Transforms-40229881'], function (exports, Matrix3, Check, defaultValue, Transforms) {
  'use strict';
  ...
  AxisAlignedBoundingBox.equals = function (left, right) {
    return left === right || defaultValue.defined(left) && defaultValue.defined(right) && Matrix3.Cartesian3.equals(left.center, right.center) && Matrix3.Cartesian3.equals(left.minimum, right.minimum) && Matrix3.Cartesian3.equals(left.maximum, right.maximum);
  };
  var intersectScratch = new Matrix3.Cartesian3();
  /**
  ...
  AxisAlignedBoundingBox.intersectPlane = function (box, plane) {
    ...
    var h = Matrix3.Cartesian3.multiplyByScalar(intersectScratch, 0.5, intersectScratch); //The positive half diagonal
    var normal = plane.normal;
    var e = h.x * Math.abs(normal.x) + h.y * Math.abs(normal.y) + h.z * Math.abs(normal.z);
    var s = Matrix3.Cartesian3.dot(box.center, normal) + plane.distance; //signed distance from center
