define(['./Matrix3-315394f6', './AxisAlignedBoundingBox-ff186ccc', './Transforms-40229881', './Matrix2-13178034', './defaultValue-0a909f67', './Check-666ab1a0', './TerrainEncoding-833187da', './Math-2dbd6b93', './OrientedBoundingBox-04920dc7', './WebMercatorProjection-13a90d41', './RuntimeError-06c93819', './createTaskProcessorWorker', './combine-ca22a614', './AttributeCompression-b646d393', './ComponentDatatype-f7b11d02', './WebGLConstants-a8cc3e8c', './EllipsoidTangentPlane-214683dc', './IntersectionTests-f6e6bd8a', './Plane-900aa728'], function (Matrix3, AxisAlignedBoundingBox, Transforms, Matrix2, defaultValue, Check, TerrainEncoding, Math$1, OrientedBoundingBox, WebMercatorProjection, RuntimeError, createTaskProcessorWorker, combine, AttributeCompression, ComponentDatatype, WebGLConstants, EllipsoidTangentPlane, IntersectionTests, Plane) {
  ...
  HeightmapTessellator.computeVertices = function (options) {
    ...
    var atan = Math.atan;
    var exp = Math.exp;
    var piOverTwo = Math$1.CesiumMath.PI_OVER_TWO;
    var toRadians = Math$1.CesiumMath.toRadians;
    ...
    var hasRelativeToCenter = defaultValue.defined(relativeToCenter);
    ...
    var exaggerationRelativeHeight = defaultValue.defaultValue(options.exaggerationRelativeHeight, 0.0);
    ...
    for (var rowIndex = startRow; rowIndex < endRow; ++rowIndex) {
      ...
      for (var colIndex = startCol; colIndex < endCol; ++colIndex) {
        ...
        var position = new Matrix3.Cartesian3();
    ...
    var encoding = new TerrainEncoding.TerrainEncoding(relativeToCenter, aaBox, hMin, maximumHeight, fromENU, false, includeWebMercatorT, includeGeodeticSurfaceNormals, exaggeration, exaggerationRelativeHeight);
      ...
      var Lerc2Decode = function () {
        ...
        ******************************************/
        var Lerc2Helpers = {
          ...
          checkMinMaxRanges: function checkMinMaxRanges(input, data) {
          ...
          readSubArray: function readSubArray(input, ptr, OutPixelTypeArray, numBytes) {
            var rawData;
          ...
          readHuffmanTree: function readHuffmanTree(input, data) {
          ...
          decodeBits: function decodeBits(input, data, blockDataBuffer, offset, iDim) {
            {
          ...
          *****************/
          ...
          getDataTypeSize: function getDataTypeSize(t) {
            var s = 0;
            switch (t) {
              case 0: //ubyte
              case 1:
        ...
        ****************************************************/
        ...
        var Lerc2Decode = {
          ...
          *****************/
           ...
           */
          decode: function decode( /*byte array*/input, /*object*/options) {
          ...
          getBandCount: function getBandCount( /*byte array*/input) {
            var count = 0;
            var i = 0;
            var temp = {};
            temp.ptr = 0;
  ...
  function createVerticesFromHeightmap(parameters, transferableObjects) {
    ...
    var statistics = HeightmapTessellator$1.computeVertices(parameters);
