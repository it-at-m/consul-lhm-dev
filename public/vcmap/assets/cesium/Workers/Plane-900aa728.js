define(['exports', './Matrix3-315394f6', './Matrix2-13178034', './Check-666ab1a0', './defaultValue-0a909f67', './Math-2dbd6b93'], function (exports, Matrix3, Matrix2, Check, defaultValue, Math) {
  'use strict';
  ...
  Plane.fromPointNormal = function (point, normal, result) {
    ...
    var distance = -Matrix3.Cartesian3.dot(normal, point);
  ...
  Plane.fromCartesian4 = function (coefficients, result) {
    ...
    var normal = Matrix3.Cartesian3.fromCartesian4(coefficients, scratchNormal);
  ...
  Plane.projectPointOntoPlane = function (plane, point, result) {
    ...
    var scaledNormal = Matrix3.Cartesian3.multiplyByScalar(plane.normal, pointDistance, scratchCartesian);
  ...
  var scratchTransformNormal = new Matrix3.Cartesian3();
  /**
  ...
  Plane.transform = function (plane, transform, result) {
    ...
    var inverseTranspose = Matrix2.Matrix4.inverseTranspose(transform, scratchInverseTranspose);
    var planeAsCartesian4 = Matrix2.Cartesian4.fromElements(normal.x, normal.y, normal.z, distance, scratchPlaneCartesian4);
    planeAsCartesian4 = Matrix2.Matrix4.multiplyByVector(inverseTranspose, planeAsCartesian4, planeAsCartesian4);

    // Convert the transformed plane to Hessian Normal Form
    var transformedNormal = Matrix3.Cartesian3.fromCartesian4(planeAsCartesian4, scratchTransformNormal);
