define(['exports', './Matrix2-13178034', './Matrix3-315394f6', './Check-666ab1a0', './defaultValue-0a909f67', './Transforms-40229881'], function (exports, Matrix2, Matrix3, Check, defaultValue, Transforms) {
  'use strict';
  ...
  var fromRectangleLowerLeft = new Matrix3.Cartographic();
  var fromRectangleUpperRight = new Matrix3.Cartographic();
  /**
  ...
  BoundingRectangle.fromRectangle = function (rectangle, projection, result) {
    ...
    var lowerLeft = projection.project(Matrix2.Rectangle.southwest(rectangle, fromRectangleLowerLeft));
    var upperRight = projection.project(Matrix2.Rectangle.northeast(rectangle, fromRectangleUpperRight));
  ...
  BoundingRectangle.equals = function (left, right) {
    return left === right || defaultValue.defined(left) && defaultValue.defined(right) && left.x === right.x && left.y === right.y && left.width === right.width && left.height === right.height;
  };
