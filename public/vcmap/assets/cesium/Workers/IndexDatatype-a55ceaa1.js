define(['exports', './defaultValue-0a909f67', './Check-666ab1a0', './Math-2dbd6b93', './WebGLConstants-a8cc3e8c'], function (exports, defaultValue, Check, Math, WebGLConstants) {
  'use strict';
  ...
  IndexDatatype.validate = function (indexDatatype) {
    return defaultValue.defined(indexDatatype) && (indexDatatype === IndexDatatype.UNSIGNED_BYTE || indexDatatype === IndexDatatype.UNSIGNED_SHORT || indexDatatype === IndexDatatype.UNSIGNED_INT);
  };
