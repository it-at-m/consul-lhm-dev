define(['exports', './Transforms-40229881', './Matrix3-315394f6', './Matrix2-13178034', './Check-666ab1a0', './ComponentDatatype-f7b11d02', './defaultValue-0a909f67', './GeometryAttribute-7d6f1732', './GeometryAttributes-f06a2792', './Math-2dbd6b93', './Plane-900aa728', './VertexFormat-6b480673'], function (exports, Transforms, Matrix3, Matrix2, Check, ComponentDatatype, defaultValue, GeometryAttribute, GeometryAttributes, Math$1, Plane, VertexFormat) {
  ...
  var faces = [new Matrix3.Cartesian3(), new Matrix3.Cartesian3(), new Matrix3.Cartesian3()];
  ...
  var scratchPlaneCenter = new Matrix3.Cartesian3();
  var scratchPlaneNormal = new Matrix3.Cartesian3();
  var scratchPlane = new Plane.Plane(new Matrix3.Cartesian3(1.0, 0.0, 0.0), 0.0);
  ...
  CullingVolume.fromBoundingSphere = function (boundingSphere, result) {
    ...
    for (var i = 0; i < length; ++i) {
      ...
      plane1.w = -Matrix3.Cartesian3.dot(Matrix3.Cartesian3.negate(faceNormal, scratchPlaneNormal), scratchPlaneCenter);
      planeIndex += 2;
    }
    return result;
  };
  ...
  function update$3(frustum) {
    //>>includeStart('debug', pragmas.debug);
    if (!defaultValue.defined(frustum.right) || !defaultValue.defined(frustum.left) || !defaultValue.defined(frustum.top) || !defaultValue.defined(frustum.bottom) || !defaultValue.defined(frustum.near) || !defaultValue.defined(frustum.far)) {
    ...
    if (frustum.top !== frustum._top || frustum.bottom !== frustum._bottom || frustum.left !== frustum._left || frustum.right !== frustum._right || frustum.near !== frustum._near || frustum.far !== frustum._far) {
      ...
      frustum._orthographicMatrix = Matrix2.Matrix4.computeOrthographicOffCenter(frustum.left, frustum.right, frustum.bottom, frustum.top, frustum.near, frustum.far, frustum._orthographicMatrix);
    }
  }
  ...
  var getPlanesRight$1 = new Matrix3.Cartesian3();
  var getPlanesNearCenter$1 = new Matrix3.Cartesian3();
  var getPlanesPoint = new Matrix3.Cartesian3();
  var negateScratch = new Matrix3.Cartesian3();
  ...
  OrthographicOffCenterFrustum.prototype.computeCullingVolume = function (position, direction, up) {
    ...
    var n = this.near;
    var f = this.far;
    var right = Matrix3.Cartesian3.cross(direction, up, getPlanesRight$1);
  ...
  OrthographicOffCenterFrustum.prototype.equals = function (other) {
    return defaultValue.defined(other) && other instanceof OrthographicOffCenterFrustum && this.right === other.right && this.left === other.left && this.top === other.top && this.bottom === other.bottom && this.near === other.near && this.far === other.far;
  };
  ...
  OrthographicFrustum.prototype.equalsEpsilon = function (other, relativeEpsilon, absoluteEpsilon) {
    ...
    update$2(this);
    update$2(other);
    return Math$1.CesiumMath.equalsEpsilon(this.width, other.width, relativeEpsilon, absoluteEpsilon) && Math$1.CesiumMath.equalsEpsilon(this.aspectRatio, other.aspectRatio, relativeEpsilon, absoluteEpsilon) && this._offCenterFrustum.equalsEpsilon(other._offCenterFrustum, relativeEpsilon, absoluteEpsilon);
  };
  ...
  function update$1(frustum) {
    ...
    if (t !== frustum._top || b !== frustum._bottom || l !== frustum._left || r !== frustum._right || n !== frustum._near || f !== frustum._far) {
      ...
      frustum._near = n;
      frustum._far = f;
      frustum._perspectiveMatrix = Matrix2.Matrix4.computePerspectiveOffCenter(l, r, b, t, n, f, frustum._perspectiveMatrix);
      frustum._infinitePerspective = Matrix2.Matrix4.computeInfinitePerspectiveOffCenter(l, r, b, t, n, frustum._infinitePerspective);
    }
  }
  ...
  var getPlanesRight = new Matrix3.Cartesian3();
  var getPlanesNearCenter = new Matrix3.Cartesian3();
  var getPlanesFarCenter = new Matrix3.Cartesian3();
  var getPlanesNormal = new Matrix3.Cartesian3();
  /**
   * Creates a culling volume for this frustum.
   *
   * @param {Cartesian3} position The eye position.
  ...
  PerspectiveOffCenterFrustum.prototype.computeCullingVolume = function (position, direction, up) {
    ...
    var n = this.near;
    var f = this.far;
    var right = Matrix3.Cartesian3.cross(direction, up, getPlanesRight);
  ...
  PerspectiveOffCenterFrustum.prototype.equals = function (other) {
    return defaultValue.defined(other) && other instanceof PerspectiveOffCenterFrustum && this.right === other.right && this.left === other.left && this.top === other.top && this.bottom === other.bottom && this.near === other.near && this.far === other.far;
  };
  ...
  PerspectiveOffCenterFrustum.prototype.equalsEpsilon = function (other, relativeEpsilon, absoluteEpsilon) {
    return other === this || defaultValue.defined(other) && other instanceof PerspectiveOffCenterFrustum && Math$1.CesiumMath.equalsEpsilon(this.right, other.right, relativeEpsilon, absoluteEpsilon) && Math$1.CesiumMath.equalsEpsilon(this.left, other.left, relativeEpsilon, absoluteEpsilon) && Math$1.CesiumMath.equalsEpsilon(this.top, other.top, relativeEpsilon, absoluteEpsilon) && Math$1.CesiumMath.equalsEpsilon(this.bottom, other.bottom, relativeEpsilon, absoluteEpsilon) && Math$1.CesiumMath.equalsEpsilon(this.near, other.near, relativeEpsilon, absoluteEpsilon) && Math$1.CesiumMath.equalsEpsilon(this.far, other.far, relativeEpsilon, absoluteEpsilon);
  };
  ...
  PerspectiveFrustum.prototype.equalsEpsilon = function (other, relativeEpsilon, absoluteEpsilon) {
    ...
    update(this);
    update(other);
    return Math$1.CesiumMath.equalsEpsilon(this.fov, other.fov, relativeEpsilon, absoluteEpsilon) && Math$1.CesiumMath.equalsEpsilon(this.aspectRatio, other.aspectRatio, relativeEpsilon, absoluteEpsilon) && this._offCenterFrustum.equalsEpsilon(other._offCenterFrustum, relativeEpsilon, absoluteEpsilon);
  };
  var PERSPECTIVE = 0;
  var ORTHOGRAPHIC = 1;
  ...
  function FrustumGeometry(options) {
     ...
     * @type {Number}
     */
    this.packedLength = 2 + frustumPackedLength + Matrix3.Cartesian3.packedLength + Transforms.Quaternion.packedLength + VertexFormat.VertexFormat.packedLength;
  }
  ...
  var scratchPackorigin = new Matrix3.Cartesian3();
  ...
  FrustumGeometry.unpack = function (array, startingIndex, result) {
    ...
    var origin = Matrix3.Cartesian3.unpack(array, startingIndex, scratchPackorigin);
    startingIndex += Matrix3.Cartesian3.packedLength;
  ...
  var scratchRotationMatrix = new Matrix3.Matrix3();
  var scratchViewMatrix = new Matrix2.Matrix4();
  var scratchInverseMatrix = new Matrix2.Matrix4();
  var scratchXDirection = new Matrix3.Cartesian3();
  var scratchYDirection = new Matrix3.Cartesian3();
  var scratchZDirection = new Matrix3.Cartesian3();
  var scratchNegativeX = new Matrix3.Cartesian3();
  var scratchNegativeY = new Matrix3.Cartesian3();
  var scratchNegativeZ = new Matrix3.Cartesian3();
  ...
  FrustumGeometry._computeNearFarPlanes = function (origin, orientation, frustumType, frustum, positions, xDirection, yDirection, zDirection) {
    var rotationMatrix = Matrix3.Matrix3.fromQuaternion(orientation, scratchRotationMatrix);
    ...
    if (frustumType === PERSPECTIVE) {
      ...
      var viewProjection = Matrix2.Matrix4.multiply(projection, view, scratchInverseMatrix);
    ...
    for (var _i = 0; _i < 2; ++_i) {
      for (var j = 0; j < 4; ++j) {
        var corner = Matrix2.Cartesian4.clone(frustumCornersNDC[j], scratchFrustumCorners[j]);
        if (!defaultValue.defined(inverseViewProjection)) {
          if (defaultValue.defined(frustum._offCenterFrustum)) {
            frustum = frustum._offCenterFrustum;
          }
          var near = frustumSplits[_i];
          var far = frustumSplits[_i + 1];
          ...
          var fac = Matrix3.Cartesian3.dot(z, corner);
          Matrix3.Cartesian3.multiplyByScalar(corner, frustumSplits[_i] / fac, corner);
          Matrix3.Cartesian3.add(corner, origin, corner);
        }
        positions[12 * _i + j * 3] = corner.x;
        positions[12 * _i + j * 3 + 1] = corner.y;
        positions[12 * _i + j * 3 + 2] = corner.z;
      }
    }
  };
  ...
  FrustumGeometry.createGeometry = function (frustumGeometry) {
    ...
    if (defaultValue.defined(vertexFormat.normal) || defaultValue.defined(vertexFormat.tangent) || defaultValue.defined(vertexFormat.bitangent) || defaultValue.defined(vertexFormat.st)) {
      ...
      var negativeX = Matrix3.Cartesian3.negate(x, scratchNegativeX);
      var negativeY = Matrix3.Cartesian3.negate(y, scratchNegativeY);
      var negativeZ = Matrix3.Cartesian3.negate(z, scratchNegativeZ);
      offset = 0;
      if (drawNearPlane) {
    ...
    for (var _i2 = 0; _i2 < numberOfPlanes; ++_i2) {
      var indexOffset = _i2 * 6;
      var index = _i2 * 4;
