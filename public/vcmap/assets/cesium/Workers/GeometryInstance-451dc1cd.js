define(['exports', './defaultValue-0a909f67', './Check-666ab1a0', './Matrix2-13178034'], function (exports, defaultValue, Check, Matrix2) {
  'use strict';
  ...
  function GeometryInstance(options) {
     ...
     */
    this.modelMatrix = Matrix2.Matrix4.clone(defaultValue.defaultValue(options.modelMatrix, Matrix2.Matrix4.IDENTITY));
