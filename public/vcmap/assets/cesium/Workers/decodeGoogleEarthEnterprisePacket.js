...
define(['./Check-666ab1a0', './RuntimeError-06c93819', './defaultValue-0a909f67', './createTaskProcessorWorker'], function (Check, RuntimeError, defaultValue, createTaskProcessorWorker) {
  'use strict';
  ...
  var adler32$1 = function adler32$1(adler, buf, len, pos) {
  ...
  var crc32$1 = function crc32$1(crc, buf, len, pos) {
    var t = crcTable;
    var end = pos + len;
    crc ^= -1;
  ...
  var inflate_table$1 = function inflate_table$1(type, lens, lens_index, codes, table, table_index, work, opts) {
    var bits = opts.bits;
  ...
  var inflate$1 = function inflate$1(strm, flush) {
    var state;
  ...
  common.flattenChunks = function (chunks) {
  ...
  function processMetadata(buffer, totalSize, quadKey) {
    ...
    function populateTiles(parentKey, parent, level) {
      ...
      for (var _i2 = 0; _i2 < 4; ++_i2) {
        var childKey = parentKey + _i2.toString();
        if (isLeaf) {
  ...
  function processTerrain(buffer, totalSize, transferableObjects) {
    ...
    // Find the sub-meshes.
    var advanceMesh = function advanceMesh(pos) {
  ...
  function uncompressPacket(data) {
    ...
    var uncompressedPacket = inflate$3.inflate(compressedPacket);
