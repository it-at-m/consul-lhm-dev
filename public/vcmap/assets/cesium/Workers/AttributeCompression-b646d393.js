define(['exports', './Matrix2-13178034', './Matrix3-315394f6', './ComponentDatatype-f7b11d02', './Check-666ab1a0', './defaultValue-0a909f67', './Math-2dbd6b93'], function (exports, Matrix2, Matrix3, ComponentDatatype, Check, defaultValue, Math$1) {
  'use strict';
  ...
  AttributeCompression.octEncodeInRange = function (vector, rangeMax, result) {
    ...
    var magSquared = Matrix3.Cartesian3.magnitudeSquared(vector);
  ...
  AttributeCompression.octDecodeInRange = function (x, y, rangeMax, result) {
    ...
    if (x < 0 || x > rangeMax || y < 0 || y > rangeMax) {
      throw new Check.DeveloperError("x and y must be unsigned normalized integers between 0 and ".concat(rangeMax));
    }
    //>>includeEnd('debug');
  ...
  AttributeCompression.dequantize = function (typedArray, componentDatatype, type, count) {
    ...
    switch (componentDatatype) {
      ...
      //>>includeStart('debug', pragmas.debug);
      default:
        throw new Check.DeveloperError("Cannot dequantize component datatype: ".concat(componentDatatype));
      //>>includeEnd('debug');
    }
  ...
  AttributeCompression.decodeRGB565 = function (typedArray, result) {
    ...
    if (defaultValue.defined(result)) {
      Check.Check.typeOf.number.equals("result.length", "typedArray.length * 3", result.length, expectedLength);
    }
    //>>includeEnd('debug');
