  ...
  CylinderGeometry.createGeometry = function (cylinderGeometry) {
    ...
    if (vertexFormat.st) {
      ...
      for (i = 0; i < numVertices; i++) {
        var position = Matrix3.Cartesian3.fromArray(positions, i * 3, positionScratch);
    ...
    var boundingSphere = new Transforms.BoundingSphere(Matrix3.Cartesian3.ZERO, Matrix2.Cartesian2.magnitude(radiusScratch));
