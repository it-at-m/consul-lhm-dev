define(['exports', './Check-666ab1a0', './defaultValue-0a909f67', './Transforms-40229881', './Math-2dbd6b93'], function (exports, Check, defaultValue, Transforms, Math$1) {
  'use strict';
  ...
  Color.fromCssColorString = function (color, result) {
    ...
    if (matches !== null) {
      return Color.fromHsl(parseFloat(matches[1]) / 360.0, parseFloat(matches[2]) / 100.0, parseFloat(matches[3]) / 100.0, parseFloat(defaultValue.defaultValue(matches[4], "1.0")), result);
    }
    result = undefined;
    return result;
  };
