define(['exports', './Transforms-40229881', './Matrix2-13178034', './Matrix3-315394f6', './ComponentDatatype-f7b11d02', './defaultValue-0a909f67', './Check-666ab1a0', './GeometryAttribute-7d6f1732', './GeometryAttributes-f06a2792', './GeometryOffsetAttribute-04332ce7', './IndexDatatype-a55ceaa1', './Math-2dbd6b93', './VertexFormat-6b480673'], function (exports, Transforms, Matrix2, Matrix3, ComponentDatatype, defaultValue, Check, GeometryAttribute, GeometryAttributes, GeometryOffsetAttribute, IndexDatatype, Math$1, VertexFormat) {
  ...
  var scratchNormalST = new Matrix3.Cartesian3();
  var defaultRadii = new Matrix3.Cartesian3(1.0, 1.0, 1.0);
  var cos = Math.cos;
  var sin = Math.sin;
  ...
  function EllipsoidGeometry(options) {
    ...
    var maximumClock = defaultValue.defaultValue(options.maximumClock, Math$1.CesiumMath.TWO_PI);
    var minimumCone = defaultValue.defaultValue(options.minimumCone, 0.0);
    var maximumCone = defaultValue.defaultValue(options.maximumCone, Math$1.CesiumMath.PI);
   ...
   * @type {Number}
   */
  EllipsoidGeometry.packedLength = 2 * Matrix3.Cartesian3.packedLength + VertexFormat.VertexFormat.packedLength + 7;
  ...
  var scratchRadii = new Matrix3.Cartesian3();
  var scratchInnerRadii = new Matrix3.Cartesian3();
  ...
  EllipsoidGeometry.unpack = function (array, startingIndex, result) {
    ...
    startingIndex = defaultValue.defaultValue(startingIndex, 0);
    var radii = Matrix3.Cartesian3.unpack(array, startingIndex, scratchRadii);
    startingIndex += Matrix3.Cartesian3.packedLength;
    var innerRadii = Matrix3.Cartesian3.unpack(array, startingIndex, scratchInnerRadii);
    startingIndex += Matrix3.Cartesian3.packedLength;
  ...
  EllipsoidGeometry.createGeometry = function (ellipsoidGeometry) {
    ...
    var ellipsoid;
    var ellipsoidOuter = Matrix3.Ellipsoid.fromCartesian3(radii);
    var ellipsoidInner = Matrix3.Ellipsoid.fromCartesian3(innerRadii);
    if (vertexFormat.st || vertexFormat.normal || vertexFormat.tangent || vertexFormat.bitangent) {
      for (i = 0; i < vertexCount; i++) {
        ellipsoid = isInner[i] ? ellipsoidInner : ellipsoidOuter;
        var position = Matrix3.Cartesian3.fromArray(positions, i * 3, scratchPosition);
        ...
        if (vertexFormat.tangent || vertexFormat.bitangent) {
          ...
          if (vertexFormat.bitangent) {
            var bitangent = Matrix3.Cartesian3.cross(normal, tangent, scratchBitangent);
