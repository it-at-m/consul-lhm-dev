...
define(['./defaultValue-0a909f67', './Check-666ab1a0', './WebGLConstants-a8cc3e8c', './RuntimeError-06c93819', './createTaskProcessorWorker'], function (defaultValue, Check, WebGLConstants, RuntimeError, createTaskProcessorWorker) {
  'use strict';
  ...
  */
  ...
  var BufferReader = /*#__PURE__*/function () {
    ...
    _createClass(BufferReader, [{
      ...
      key: "_scan",
      value: function _scan(maxByteLength) {
        var term = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0x00;
  ...
  function transcodeCompressed(data, header, supportedTargetFormats, transcoderModule, transferableObjects, result) {
    ...
    for (var i = 0; i < header.levels.length; ++i) {
      ...
      var dstSize = ktx2File.getImageTranscodedSizeInBytes(i,
      // level index
      0,
      // layer index
      0,
      ...
      var transcoded = ktx2File.transcodeImage(dst, i,
      // level index
      0,
      // layer index
      0,
      // face index
      transcoderFormat.value, 0,
