define(['exports', './Matrix2-13178034', './Matrix3-315394f6', './Check-666ab1a0', './defaultValue-0a909f67', './WebGLConstants-a8cc3e8c', './Transforms-40229881'], function (exports, Matrix2, Matrix3, Check, defaultValue, WebGLConstants, Transforms) {
  'use strict';
  ...
  Geometry.computeNumberOfVertices = function (geometry) {
    ...
    for (var property in geometry.attributes) {
      if (geometry.attributes.hasOwnProperty(property) && defaultValue.defined(geometry.attributes[property]) && defaultValue.defined(geometry.attributes[property].values)) {
  ...
  var enuCenterScratch = new Matrix3.Cartesian3();
  var fixedFrameToEnuScratch = new Matrix2.Matrix4();
  var boundingRectanglePointsCartographicScratch = [new Matrix3.Cartographic(), new Matrix3.Cartographic(), new Matrix3.Cartographic()];
  var boundingRectanglePointsEnuScratch = [new Matrix2.Cartesian2(), new Matrix2.Cartesian2(), new Matrix2.Cartesian2()];
  var points2DScratch = [new Matrix2.Cartesian2(), new Matrix2.Cartesian2(), new Matrix2.Cartesian2()];
  var pointEnuScratch = new Matrix3.Cartesian3();
  ...
  Geometry._textureCoordinateRotationPoints = function (positions, stRotation, ellipsoid, boundingRectangle) {
    ...
    var rectangleCenter = Matrix2.Rectangle.center(boundingRectangle, rectangleCenterScratch);
    var enuCenter = Matrix3.Cartographic.toCartesian(rectangleCenter, ellipsoid, enuCenterScratch);
    var enuToFixedFrame = Transforms.Transforms.eastNorthUpToFixedFrame(enuCenter, ellipsoid, fixedFrameToEnuScratch);
    var fixedFrameToEnu = Matrix2.Matrix4.inverse(enuToFixedFrame, fixedFrameToEnuScratch);
    ...
    var rotation = Transforms.Quaternion.fromAxisAngle(Matrix3.Cartesian3.UNIT_Z, -stRotation, enuRotationScratch);
    var textureMatrix = Matrix3.Matrix3.fromQuaternion(rotation, enuRotationMatrixScratch);
