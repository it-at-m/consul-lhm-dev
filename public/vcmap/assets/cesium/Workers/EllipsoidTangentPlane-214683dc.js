define(['exports', './AxisAlignedBoundingBox-ff186ccc', './Matrix2-13178034', './Matrix3-315394f6', './Check-666ab1a0', './defaultValue-0a909f67', './IntersectionTests-f6e6bd8a', './Plane-900aa728', './Transforms-40229881'], function (exports, AxisAlignedBoundingBox, Matrix2, Matrix3, Check, defaultValue, IntersectionTests, Plane, Transforms) {
  'use strict';
  ...
  function EllipsoidTangentPlane(origin, ellipsoid) {
    ...
    this._origin = origin;
    this._xAxis = Matrix3.Cartesian3.fromCartesian4(Matrix2.Matrix4.getColumn(eastNorthUp, 0, scratchCart4));
    this._yAxis = Matrix3.Cartesian3.fromCartesian4(Matrix2.Matrix4.getColumn(eastNorthUp, 1, scratchCart4));
    var normal = Matrix3.Cartesian3.fromCartesian4(Matrix2.Matrix4.getColumn(eastNorthUp, 2, scratchCart4));
  ...
  var scratchProjectPointOntoPlaneCartesian3 = new Matrix3.Cartesian3();
  ...
  EllipsoidTangentPlane.prototype.projectPointOntoPlane = function (cartesian, result) {
    ...
    if (defaultValue.defined(intersectionPoint)) {
      var v = Matrix3.Cartesian3.subtract(intersectionPoint, this._origin, intersectionPoint);
      var x = Matrix3.Cartesian3.dot(this._xAxis, v);
      var y = Matrix3.Cartesian3.dot(this._yAxis, v);
  ...
  var projectPointsOntoEllipsoidScratch = new Matrix3.Cartesian3();
  /**
