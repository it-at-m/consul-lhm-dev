define(['exports', './Transforms-40229881', './Matrix2-13178034', './Matrix3-315394f6', './Check-666ab1a0', './defaultValue-0a909f67', './EllipsoidTangentPlane-214683dc', './Math-2dbd6b93', './Plane-900aa728'], function (exports, Transforms, Matrix2, Matrix3, Check, defaultValue, EllipsoidTangentPlane, Math$1, Plane) {
  'use strict';
  ...
  var scratchCovarianceResult = new Matrix3.Matrix3();
  ...
  OrientedBoundingBox.fromPoints = function (positions, result) {
    ...
    var meanPoint = Matrix3.Cartesian3.clone(positions[0], scratchCartesian1);
    for (i = 1; i < length; i++) {
    ...
    var eigenDecomposition = Matrix3.Matrix3.computeEigenDecomposition(covarianceMatrix, scratchEigenResult);
    var rotation = Matrix3.Matrix3.clone(eigenDecomposition.unitary, result.halfAxes);
    var v1 = Matrix3.Matrix3.getColumn(rotation, 0, scratchCartesian4);
    var v2 = Matrix3.Matrix3.getColumn(rotation, 1, scratchCartesian5);
    var v3 = Matrix3.Matrix3.getColumn(rotation, 2, scratchCartesian6);
    ...
    var center = Matrix3.Cartesian3.add(v1, v2, result.center);
  ...
  var scratchOffset = new Matrix3.Cartesian3();
  var scratchScale = new Matrix3.Cartesian3();
  function fromPlaneExtents(planeOrigin, planeXAxis, planeYAxis, planeZAxis, minimumX, maximumX, minimumY, maximumY, minimumZ, maximumZ, result) {
    //>>includeStart('debug', pragmas.debug);
    if (!defaultValue.defined(minimumX) || !defaultValue.defined(maximumX) || !defaultValue.defined(minimumY) || !defaultValue.defined(maximumY) || !defaultValue.defined(minimumZ) || !defaultValue.defined(maximumZ)) {
  ...
  var scratchRectangleCenterCartographic = new Matrix3.Cartographic();
  var scratchRectangleCenter = new Matrix3.Cartesian3();
  var scratchPerimeterCartographicNC = new Matrix3.Cartographic();
  var scratchPerimeterCartographicNW = new Matrix3.Cartographic();
  var scratchPerimeterCartographicCW = new Matrix3.Cartographic();
  var scratchPerimeterCartographicSW = new Matrix3.Cartographic();
  var scratchPerimeterCartographicSC = new Matrix3.Cartographic();
  var scratchPerimeterCartesianNC = new Matrix3.Cartesian3();
  var scratchPerimeterCartesianNW = new Matrix3.Cartesian3();
  var scratchPerimeterCartesianCW = new Matrix3.Cartesian3();
  var scratchPerimeterCartesianSW = new Matrix3.Cartesian3();
  var scratchPerimeterCartesianSC = new Matrix3.Cartesian3();
  ...
  var scratchPlaneOrigin = new Matrix3.Cartesian3();
  var scratchPlaneNormal = new Matrix3.Cartesian3();
  var scratchPlaneXAxis = new Matrix3.Cartesian3();
  var scratchHorizonCartesian = new Matrix3.Cartesian3();
  var scratchHorizonProjected = new Matrix2.Cartesian2();
  var scratchMaxY = new Matrix3.Cartesian3();
  var scratchMinY = new Matrix3.Cartesian3();
  var scratchZ = new Matrix3.Cartesian3();
  var scratchPlane = new Plane.Plane(Matrix3.Cartesian3.UNIT_X, 0.0);
  ...
  OrientedBoundingBox.fromRectangle = function (rectangle, minimumHeight, maximumHeight, ellipsoid, result) {
    ...
    if (defaultValue.defined(ellipsoid) && !Math$1.CesiumMath.equalsEpsilon(ellipsoid.radii.x, ellipsoid.radii.y, Math$1.CesiumMath.EPSILON15)) {
    ...
    if (rectangle.width <= Math$1.CesiumMath.PI) {
      ...
      var perimeterCartographicNC = Matrix3.Cartographic.fromRadians(lonCenter, rectangle.north, maximumHeight, scratchPerimeterCartographicNC);
      var perimeterCartographicNW = Matrix3.Cartographic.fromRadians(rectangle.west, rectangle.north, maximumHeight, scratchPerimeterCartographicNW);
      var perimeterCartographicCW = Matrix3.Cartographic.fromRadians(rectangle.west, latCenter, maximumHeight, scratchPerimeterCartographicCW);
      var perimeterCartographicSW = Matrix3.Cartographic.fromRadians(rectangle.west, rectangle.south, maximumHeight, scratchPerimeterCartographicSW);
      var perimeterCartographicSC = Matrix3.Cartographic.fromRadians(lonCenter, rectangle.south, maximumHeight, scratchPerimeterCartographicSC);
    ...
    var planeOrigin = Matrix3.Cartesian3.fromRadians(centerLongitude, latitudeNearestToEquator, maximumHeight, ellipsoid, scratchPlaneOrigin);
    ...
    var planeNormal = !isPole ? Matrix3.Cartesian3.normalize(planeOrigin, scratchPlaneNormal) : Matrix3.Cartesian3.UNIT_X;
    var planeYAxis = Matrix3.Cartesian3.UNIT_Z;
    var planeXAxis = Matrix3.Cartesian3.cross(planeNormal, planeYAxis, scratchPlaneXAxis);
    plane = Plane.Plane.fromPointNormal(planeOrigin, planeNormal, scratchPlane);

    // Get the horizon point relative to the center. This will be the farthest extent in the plane's X dimension.
    var horizonCartesian = Matrix3.Cartesian3.fromRadians(centerLongitude + Math$1.CesiumMath.PI_OVER_TWO, latitudeNearestToEquator, maximumHeight, ellipsoid, scratchHorizonCartesian);
    maxX = Matrix3.Cartesian3.dot(Plane.Plane.projectPointOntoPlane(plane, horizonCartesian, scratchHorizonProjected), planeXAxis);
    minX = -maxX; // symmetrical

    // Get the min and max Y, using the height that will give the largest extent
    maxY = Matrix3.Cartesian3.fromRadians(0.0, rectangle.north, fullyBelowEquator ? minimumHeight : maximumHeight, ellipsoid, scratchMaxY).z;
    minY = Matrix3.Cartesian3.fromRadians(0.0, rectangle.south, fullyAboveEquator ? minimumHeight : maximumHeight, ellipsoid, scratchMinY).z;
    var farZ = Matrix3.Cartesian3.fromRadians(rectangle.east, latitudeNearestToEquator, maximumHeight, ellipsoid, scratchZ);
  ...
  var scratchCartesianU = new Matrix3.Cartesian3();
  var scratchCartesianV = new Matrix3.Cartesian3();
  var scratchCartesianW = new Matrix3.Cartesian3();
  var scratchValidAxis2 = new Matrix3.Cartesian3();
  var scratchValidAxis3 = new Matrix3.Cartesian3();
  var scratchPPrime = new Matrix3.Cartesian3();
  ...
  OrientedBoundingBox.distanceSquaredTo = function (box, cartesian) {
    ...
    var offset = Matrix3.Cartesian3.subtract(cartesian, box.center, scratchOffset);
    var halfAxes = box.halfAxes;
    var u = Matrix3.Matrix3.getColumn(halfAxes, 0, scratchCartesianU);
    var v = Matrix3.Matrix3.getColumn(halfAxes, 1, scratchCartesianV);
    var w = Matrix3.Matrix3.getColumn(halfAxes, 2, scratchCartesianW);
    var uHalf = Matrix3.Cartesian3.magnitude(u);
    var vHalf = Matrix3.Cartesian3.magnitude(v);
    var wHalf = Matrix3.Cartesian3.magnitude(w);
    var uValid = true;
    var vValid = true;
    var wValid = true;
    if (uHalf > 0) {
    ...
    if (numberOfDegenerateAxes === 1) {
      ...
      var crossVector = Matrix3.Cartesian3.UNIT_Y;
  ...
  var scratchCorner = new Matrix3.Cartesian3();
  var scratchToCenter = new Matrix3.Cartesian3();
  ...
  OrientedBoundingBox.computePlaneDistances = function (box, position, direction, result) {
    ...
    var corner = Matrix3.Cartesian3.add(u, v, scratchCorner);
    Matrix3.Cartesian3.add(corner, w, corner);
    Matrix3.Cartesian3.add(corner, center, corner);
    var toCenter = Matrix3.Cartesian3.subtract(corner, position, scratchToCenter);
  ...
  OrientedBoundingBox.computeCorners = function (box, result) {
    ...
    if (!defaultValue.defined(result)) {
      result = [new Matrix3.Cartesian3(), new Matrix3.Cartesian3(), new Matrix3.Cartesian3(), new Matrix3.Cartesian3(), new Matrix3.Cartesian3(), new Matrix3.Cartesian3(), new Matrix3.Cartesian3(), new Matrix3.Cartesian3()];
    }
    var center = box.center;
    var halfAxes = box.halfAxes;
  ...
  var scratchRotationScale = new Matrix3.Matrix3();
  ...
  OrientedBoundingBox.computeTransformation = function (box, result) {
    ...
    var rotationScale = Matrix3.Matrix3.multiplyByUniformScale(box.halfAxes, 2.0, scratchRotationScale);
  ...
  OrientedBoundingBox.equals = function (left, right) {
    return left === right || defaultValue.defined(left) && defaultValue.defined(right) && Matrix3.Cartesian3.equals(left.center, right.center) && Matrix3.Matrix3.equals(left.halfAxes, right.halfAxes);
  };
