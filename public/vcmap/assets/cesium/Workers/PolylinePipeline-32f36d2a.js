define(['exports', './Matrix3-315394f6', './defaultValue-0a909f67', './Check-666ab1a0', './EllipsoidGeodesic-98c62a56', './EllipsoidRhumbLine-19756602', './IntersectionTests-f6e6bd8a', './Math-2dbd6b93', './Matrix2-13178034', './Plane-900aa728'], function (exports, Matrix3, defaultValue, Check, EllipsoidGeodesic, EllipsoidRhumbLine, IntersectionTests, Math$1, Matrix2, Plane) {
  ...
  var cartoScratch = new Matrix3.Cartographic();
  ...
  var wrapLongitudeOrigin = new Matrix3.Cartesian3();
  var wrapLongitudeXZNormal = new Matrix3.Cartesian3();
  var wrapLongitudeXZPlane = new Plane.Plane(Matrix3.Cartesian3.UNIT_X, 0.0);
  var wrapLongitudeYZNormal = new Matrix3.Cartesian3();
  var wrapLongitudeYZPlane = new Plane.Plane(Matrix3.Cartesian3.UNIT_X, 0.0);
  var wrapLongitudeIntersection = new Matrix3.Cartesian3();
  var wrapLongitudeOffset = new Matrix3.Cartesian3();
  ...
  var carto1 = new Matrix3.Cartographic();
  var carto2 = new Matrix3.Cartographic();
  var cartesian = new Matrix3.Cartesian3();
  var scaleFirst = new Matrix3.Cartesian3();
  var scaleLast = new Matrix3.Cartesian3();
  ...
  PolylinePipeline.wrapLongitude = function (positions, modelMatrix) {
    ...
    if (defaultValue.defined(positions) && positions.length > 0) {
      ...
      var inverseModelMatrix = Matrix2.Matrix4.inverseTransformation(modelMatrix, wrapLongitudeInversMatrix);
      var origin = Matrix2.Matrix4.multiplyByPoint(inverseModelMatrix, Matrix3.Cartesian3.ZERO, wrapLongitudeOrigin);
      var xzNormal = Matrix3.Cartesian3.normalize(Matrix2.Matrix4.multiplyByPointAsVector(inverseModelMatrix, Matrix3.Cartesian3.UNIT_Y, wrapLongitudeXZNormal), wrapLongitudeXZNormal);
      var xzPlane = Plane.Plane.fromPointNormal(origin, xzNormal, wrapLongitudeXZPlane);
      var yzNormal = Matrix3.Cartesian3.normalize(Matrix2.Matrix4.multiplyByPointAsVector(inverseModelMatrix, Matrix3.Cartesian3.UNIT_X, wrapLongitudeYZNormal), wrapLongitudeYZNormal);
      ...
      for (var i = 1; i < length; ++i) {
        ...
        if (Plane.Plane.getPointDistance(yzPlane, prev) < 0.0 || Plane.Plane.getPointDistance(yzPlane, cur) < 0.0) {
          ...
          if (defaultValue.defined(intersection)) {
            ...
            var offset = Matrix3.Cartesian3.multiplyByScalar(xzNormal, 5.0e-9, wrapLongitudeOffset);
