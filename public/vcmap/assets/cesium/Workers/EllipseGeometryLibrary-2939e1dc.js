define(['exports', './Matrix3-315394f6', './Math-2dbd6b93', './Transforms-40229881'], function (exports, Matrix3, Math$1, Transforms) {
  'use strict';

  var EllipseGeometryLibrary = {};
  var rotAxis = new Matrix3.Cartesian3();
  var tempVec = new Matrix3.Cartesian3();
  var unitQuat = new Transforms.Quaternion();
  var rotMtx = new Matrix3.Matrix3();
  ...
  EllipseGeometryLibrary.raisePositionsToHeight = function (positions, options, extrude) {
    ...
    for (var i = 0; i < length; i += 3) {
      ...
      var extrudedPosition = Matrix3.Cartesian3.clone(position, scratchCartesian2);
      var normal = ellipsoid.geodeticSurfaceNormal(position, scratchNormal);
      var scaledNormal = Matrix3.Cartesian3.multiplyByScalar(normal, height, scratchCartesian3);
  ...
  var unitPosScratch = new Matrix3.Cartesian3();
  var eastVecScratch = new Matrix3.Cartesian3();
  var northVecScratch = new Matrix3.Cartesian3();
  /**
  ...
  EllipseGeometryLibrary.computeEllipsePositions = function (options, addFillPositions, addEdgePositions) {
    ...
    var mag = Matrix3.Cartesian3.magnitude(center);
    var unitPos = Matrix3.Cartesian3.normalize(center, unitPosScratch);
    var eastVec = Matrix3.Cartesian3.cross(Matrix3.Cartesian3.UNIT_Z, center, eastVecScratch);
    eastVec = Matrix3.Cartesian3.normalize(eastVec, eastVec);
    var northVec = Matrix3.Cartesian3.cross(unitPos, eastVec, northVecScratch);
    ...
    for (i = 1; i < numPts + 1; ++i) {
      ...
      if (addFillPositions) {
        ...
        for (j = 1; j < numInterior - 1; ++j) {
          t = j / (numInterior - 1);
          interiorPosition = Matrix3.Cartesian3.lerp(position, reflectedPosition, t, scratchCartesian3);
