define(['./Transforms-40229881', './Matrix3-315394f6', './Check-666ab1a0', './ComponentDatatype-f7b11d02', './defaultValue-0a909f67', './GeometryAttribute-7d6f1732', './GeometryAttributes-f06a2792', './GeometryOffsetAttribute-04332ce7', './Math-2dbd6b93', './Matrix2-13178034', './RuntimeError-06c93819', './combine-ca22a614', './WebGLConstants-a8cc3e8c'], function (Transforms, Matrix3, Check, ComponentDatatype, defaultValue, GeometryAttribute, GeometryAttributes, GeometryOffsetAttribute, Math, Matrix2, RuntimeError, combine, WebGLConstants) {
  'use strict';
  ...
  BoxOutlineGeometry.pack = function (value, array, startingIndex) {
    ...
    array[startingIndex + Matrix3.Cartesian3.packedLength * 2] = defaultValue.defaultValue(value._offsetAttribute, -1);
    return array;
  };
  ...
  BoxOutlineGeometry.unpack = function (array, startingIndex, result) {
    ...
    var offsetAttribute = array[startingIndex + Matrix3.Cartesian3.packedLength * 2];
