define(['exports', './Matrix2-13178034', './Matrix3-315394f6', './Check-666ab1a0', './ComponentDatatype-f7b11d02', './defaultValue-0a909f67', './EllipsoidRhumbLine-19756602', './GeometryAttribute-7d6f1732', './Math-2dbd6b93', './WebGLConstants-a8cc3e8c'], function (exports, Matrix2, Matrix3, Check, ComponentDatatype, defaultValue, EllipsoidRhumbLine, GeometryAttribute, Math$1, WebGLConstants) {
  'use strict';
  ...
  var scaleToGeodeticHeightN = new Matrix3.Cartesian3();
  var scaleToGeodeticHeightP = new Matrix3.Cartesian3();
  ...
  var subdivisionV0Scratch = new Matrix3.Cartesian3();
  var subdivisionV1Scratch = new Matrix3.Cartesian3();
  var subdivisionV2Scratch = new Matrix3.Cartesian3();
  var subdivisionS0Scratch = new Matrix3.Cartesian3();
  var subdivisionS1Scratch = new Matrix3.Cartesian3();
  var subdivisionS2Scratch = new Matrix3.Cartesian3();
  var subdivisionMidScratch = new Matrix3.Cartesian3();
  var subdivisionT0Scratch = new Matrix2.Cartesian2();
  var subdivisionT1Scratch = new Matrix2.Cartesian2();
  var subdivisionT2Scratch = new Matrix2.Cartesian2();
  var subdivisionTexcoordMidScratch = new Matrix2.Cartesian2();
  ...
  PolygonPipeline.computeSubdivision = function (ellipsoid, positions, indices, texcoords, granularity) {
    ...
    var hasTexcoords = defaultValue.defined(texcoords);
    ...
    var subdividedTexcoords = new Array(length * 2);
    var q = 0;
    var p = 0;
    for (i = 0; i < length; i++) {
    ...
    while (triangles.length > 0) {
      ...
      var v0 = Matrix3.Cartesian3.fromArray(subdividedPositions, i0 * 3, subdivisionV0Scratch);
      var v1 = Matrix3.Cartesian3.fromArray(subdividedPositions, i1 * 3, subdivisionV1Scratch);
      var v2 = Matrix3.Cartesian3.fromArray(subdividedPositions, i2 * 3, subdivisionV2Scratch);
      var t0 = void 0,
        t1 = void 0,
        t2 = void 0;
      if (hasTexcoords) {
      ...
      var s0 = Matrix3.Cartesian3.multiplyByScalar(Matrix3.Cartesian3.normalize(v0, subdivisionS0Scratch), radius, subdivisionS0Scratch);
      var s1 = Matrix3.Cartesian3.multiplyByScalar(Matrix3.Cartesian3.normalize(v1, subdivisionS1Scratch), radius, subdivisionS1Scratch);
      var s2 = Matrix3.Cartesian3.multiplyByScalar(Matrix3.Cartesian3.normalize(v2, subdivisionS2Scratch), radius, subdivisionS2Scratch);
      var g0 = Matrix3.Cartesian3.magnitudeSquared(Matrix3.Cartesian3.subtract(s0, s1, subdivisionMidScratch));
      var g1 = Matrix3.Cartesian3.magnitudeSquared(Matrix3.Cartesian3.subtract(s1, s2, subdivisionMidScratch));
      var g2 = Matrix3.Cartesian3.magnitudeSquared(Matrix3.Cartesian3.subtract(s2, s0, subdivisionMidScratch));
      var max = Math.max(g0, g1, g2);
      var edge = void 0;
      var mid = void 0;
      var midTexcoord = void 0;

      // if the max length squared of a triangle edge is greater than the chord length of squared
      // of the granularity, subdivide the triangle
      if (max > minDistanceSqrd) {
        if (g0 === max) {
          edge = "".concat(Math.min(i0, i1), " ").concat(Math.max(i0, i1));
          i = edges[edge];
          ...
          edge = "".concat(Math.min(i1, i2), " ").concat(Math.max(i1, i2));
          i = edges[edge];
          if (!defaultValue.defined(i)) {
          ...
          edge = "".concat(Math.min(i2, i0), " ").concat(Math.max(i2, i0));
          i = edges[edge];
          if (!defaultValue.defined(i)) {
  ...
  var subdivisionC0Scratch = new Matrix3.Cartographic();
  var subdivisionC1Scratch = new Matrix3.Cartographic();
  var subdivisionC2Scratch = new Matrix3.Cartographic();
  var subdivisionCartographicScratch = new Matrix3.Cartographic();
  ...
  PolygonPipeline.computeRhumbLineSubdivision = function (ellipsoid, positions, indices, texcoords, granularity) {
    ...
    while (triangles.length > 0) {
      ...
      var edge = void 0;
      var mid = void 0;
      var midHeight = void 0;
      var midCartesian3 = void 0;
      var midTexcoord = void 0;
      ...
      if (max > minDistance) {
        if (g0 === max) {
          ...
          if (!defaultValue.defined(i)) {
            ...
            midCartesian3 = Matrix3.Cartesian3.fromRadians(mid.longitude, mid.latitude, midHeight, ellipsoid, subdivisionMidScratch);
