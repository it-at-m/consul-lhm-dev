define(['./AttributeCompression-b646d393', './Matrix3-315394f6', './Color-a84038cb', './defaultValue-0a909f67', './IndexDatatype-a55ceaa1', './Math-2dbd6b93', './OrientedBoundingBox-04920dc7', './Matrix2-13178034', './createTaskProcessorWorker', './ComponentDatatype-f7b11d02', './Check-666ab1a0', './WebGLConstants-a8cc3e8c', './Transforms-40229881', './combine-ca22a614', './RuntimeError-06c93819', './EllipsoidTangentPlane-214683dc', './AxisAlignedBoundingBox-ff186ccc', './IntersectionTests-f6e6bd8a', './Plane-900aa728'], function (AttributeCompression, Matrix3, Color, defaultValue, IndexDatatype, Math$1, OrientedBoundingBox, Matrix2, createTaskProcessorWorker, ComponentDatatype, Check, WebGLConstants, Transforms, combine, RuntimeError, EllipsoidTangentPlane, AxisAlignedBoundingBox, IntersectionTests, Plane) {
  ...
  var scratchScaledNormal = new Matrix3.Cartesian3();
  var scratchMinHeightPosition = new Matrix3.Cartesian3();
  var scratchMaxHeightPosition = new Matrix3.Cartesian3();
  ...
  function createVectorTilePolygons(parameters, transferableObjects) {
    ...
    for (i = 0; i < positionsLength; ++i) {
      var u = uBuffer[i];
      var v = vBuffer[i];
      var x = Math$1.CesiumMath.lerp(rectangle.west, rectangle.east, u / maxShort);
      var y = Math$1.CesiumMath.lerp(rectangle.south, rectangle.north, v / maxShort);
      var cart = Matrix3.Cartographic.fromRadians(x, y, 0.0, scratchBVCartographic);
    ...
    for (i = 0; i < countsLength; ++i) {
      ...
      for (j = 0; j < polygonCount; ++j) {
        var position = Matrix3.Cartesian3.unpack(decodedPositions, polygonOffset * 3 + j * 3, scratchEncodedPosition);
        ...
        var scaledNormal = Matrix3.Cartesian3.multiplyByScalar(normal, polygonMinimumHeight, scratchScaledNormal);
        var minHeightPosition = Matrix3.Cartesian3.add(position, scaledNormal, scratchMinHeightPosition);
        scaledNormal = Matrix3.Cartesian3.multiplyByScalar(normal, polygonMaximumHeight, scaledNormal);
        var maxHeightPosition = Matrix3.Cartesian3.add(position, scaledNormal, scratchMaxHeightPosition);
