define(['./AttributeCompression-b646d393', './Transforms-40229881', './Matrix2-13178034', './Matrix3-315394f6', './defaultValue-0a909f67', './TerrainEncoding-833187da', './IndexDatatype-a55ceaa1', './Check-666ab1a0', './Math-2dbd6b93', './OrientedBoundingBox-04920dc7', './createTaskProcessorWorker', './ComponentDatatype-f7b11d02', './WebGLConstants-a8cc3e8c', './combine-ca22a614', './RuntimeError-06c93819', './EllipsoidTangentPlane-214683dc', './AxisAlignedBoundingBox-ff186ccc', './IntersectionTests-f6e6bd8a', './Plane-900aa728'], function (AttributeCompression, Transforms, Matrix2, Matrix3, defaultValue, TerrainEncoding, IndexDatatype, Check, Math$1, OrientedBoundingBox, createTaskProcessorWorker, ComponentDatatype, WebGLConstants, combine, RuntimeError, EllipsoidTangentPlane, AxisAlignedBoundingBox, IntersectionTests, Plane) {
  ...
  var indicesScratch = [];
  var normalsScratch = [];
  var horizonOcclusionPointScratch = new Matrix3.Cartesian3();
  ...
  var octEncodedNormalScratch = new Matrix3.Cartesian3();
  function upsampleQuantizedTerrainMesh(parameters, transferableObjects) {
    ...
    for (i = 0, n = 0; i < quantizedVertexCount; ++i, n += 2) {
      ...
      parentHeightBuffer[i] = Math$1.CesiumMath.clamp((height - parentMinimumHeight) / (parentMaximumHeight - parentMinimumHeight) * maxShort | 0, 0, maxShort);
      if (u < threshold) {
        u = 0;
      }
      if (v < threshold) {
    ...
    for (i = 0; i < parentIndices.length; i += 3) {
      ...
      var clipped = Intersections2D$1.clipTriangleAtAxisAlignedThreshold(halfMaxShort, isEastChild, u0, u1, u2, clipScratch);
      ...
      clipped2 = Intersections2D$1.clipTriangleAtAxisAlignedThreshold(halfMaxShort, isNorthChild, clippedTriangleVertices[0].getV(), clippedTriangleVertices[1].getV(), clippedTriangleVertices[2].getV(), clipScratch2);
    ...
    for (i = 0; i < uBuffer.length; ++i) {
      ...
      vBuffer[i] = v;
      height = Math$1.CesiumMath.lerp(parentMinimumHeight, parentMaximumHeight, heightBuffer[i] / maxShort);
    ...
    var boundingSphere = Transforms.BoundingSphere.fromVertices(cartesianVertices, Matrix3.Cartesian3.ZERO, 3, boundingSphereScratch);
  ...
  var depth = -1;
  var cartesianScratch1 = [new Matrix3.Cartesian3(), new Matrix3.Cartesian3()];
  var cartesianScratch2 = [new Matrix3.Cartesian3(), new Matrix3.Cartesian3()];
