define(['exports', './AttributeCompression-b646d393', './Matrix2-13178034', './Matrix3-315394f6', './Check-666ab1a0', './defaultValue-0a909f67', './Math-2dbd6b93', './Transforms-40229881', './ComponentDatatype-f7b11d02', './EncodedCartesian3-81f70735', './GeometryAttribute-7d6f1732', './IndexDatatype-a55ceaa1', './IntersectionTests-f6e6bd8a', './Plane-900aa728'], function (exports, AttributeCompression, Matrix2, Matrix3, Check, defaultValue, Math$1, Transforms, ComponentDatatype, EncodedCartesian3, GeometryAttribute, IndexDatatype, IntersectionTests, Plane) {
  ...
  Tipsify.tipsify = function (options) {
    ...
    function getNextVertex(indices, cacheSize, oneRing, vertices, s, deadEnd, maximumIndexPlusOne) {
      ...
      while (itOneRing < oneRing.length) {
        var _index = oneRing[itOneRing];
        if (vertices[_index].numLiveTriangles) {
          p = 0;
          if (s - vertices[_index].timeStamp + 2 * vertices[_index].numLiveTriangles <= cacheSize) {
            p = s - vertices[_index].timeStamp;
          }
          if (p > m || m === -1) {
            m = p;
            n = _index;
  ...
  GeometryPipeline.createLineSegmentsForVectors = function (geometry, attributeName, length) {
    ...
    if (!defaultValue.defined(geometry.attributes[attributeName])) {
      throw new Check.DeveloperError("geometry.attributes must have an attribute with the same name as the attributeName parameter, ".concat(attributeName, "."));
    }
    //>>includeEnd('debug');
  ...
  GeometryPipeline.createAttributeLocations = function (geometry) {
    ...
    var semantics = ["position", "positionHigh", "positionLow",
  ...
  GeometryPipeline.reorderForPreVertexCache = function (geometry) {
    ...
    if (defaultValue.defined(indices)) {
      ...
      for (var property in attributes) {
        if (attributes.hasOwnProperty(property) && defaultValue.defined(attributes[property]) && defaultValue.defined(attributes[property].values)) {
  ...
  function copyAttributesDescriptions(attributes) {
    ...
    for (var attribute in attributes) {
      if (attributes.hasOwnProperty(attribute) && defaultValue.defined(attributes[attribute]) && defaultValue.defined(attributes[attribute].values)) {
  ...
  function copyVertex(destinationAttributes, sourceAttributes, index) {
    for (var attribute in sourceAttributes) {
      if (sourceAttributes.hasOwnProperty(attribute) && defaultValue.defined(sourceAttributes[attribute]) && defaultValue.defined(sourceAttributes[attribute].values)) {
  ...
  GeometryPipeline.fitToUnsignedShortIndices = function (geometry) {
    ...
    if (defaultValue.defined(geometry.indices) && geometry.primitiveType !== GeometryAttribute.PrimitiveType.TRIANGLES && geometry.primitiveType !== GeometryAttribute.PrimitiveType.LINES && geometry.primitiveType !== GeometryAttribute.PrimitiveType.POINTS) {
    ...
    if (defaultValue.defined(geometry.indices) && numberOfVertices >= Math$1.CesiumMath.SIXTY_FOUR_KILOBYTES) {
      var oldToNewIndex = [];
      var newIndices = [];
      var currentIndex = 0;
  ...
  var scratchProjectTo2DCartesian3 = new Matrix3.Cartesian3();
  var scratchProjectTo2DCartographic = new Matrix3.Cartographic();
  ...
  GeometryPipeline.projectTo2D = function (geometry, attributeName, attributeName3D, attributeName2D, projection) {
    ...
    if (!defaultValue.defined(geometry.attributes[attributeName])) {
      throw new Check.DeveloperError("geometry must have attribute matching the attributeName argument: ".concat(attributeName, "."));
    }
    ...
    for (var i = 0; i < values3D.length; i += 3) {
      var value = Matrix3.Cartesian3.fromArray(values3D, i, scratchProjectTo2DCartesian3);
      var lonLat = ellipsoid.cartesianToCartographic(value, scratchProjectTo2DCartographic);
      //>>includeStart('debug', pragmas.debug);
      if (!defaultValue.defined(lonLat)) {
        throw new Check.DeveloperError("Could not project point (".concat(value.x, ", ").concat(value.y, ", ").concat(value.z, ") to 2D."));
      }
      //>>includeEnd('debug');
  ...
  var normalMatrix = new Matrix3.Matrix3();
  ...
  GeometryPipeline.transformToWorldCoordinates = function (instance) {
    ...
    if (defaultValue.defined(attributes.normal) || defaultValue.defined(attributes.tangent) || defaultValue.defined(attributes.bitangent)) {
  ...
  function findAttributesInAllGeometries(instances, propertyName) {
    ...
    for (name in attributes0) {
      if (attributes0.hasOwnProperty(name) && defaultValue.defined(attributes0[name]) && defaultValue.defined(attributes0[name].values)) {
        ...
        for (var i = 1; i < length; ++i) {
          ...
          if (!defaultValue.defined(otherAttribute) || attribute.componentDatatype !== otherAttribute.componentDatatype || attribute.componentsPerAttribute !== otherAttribute.componentsPerAttribute || attribute.normalize !== otherAttribute.normalize) {
  ...
  var tempScratch = new Matrix3.Cartesian3();
  function combineGeometries(instances, propertyName) {
    ...
    var center = new Matrix3.Cartesian3();
    var radius = 0.0;
    var bs;
    for (i = 0; i < length; ++i) {
    ...
    if (defaultValue.defined(center)) {
      ...
      for (i = 0; i < length; ++i) {
        bs = instances[i][propertyName].boundingSphere;
        var tempRadius = Matrix3.Cartesian3.magnitude(Matrix3.Cartesian3.subtract(bs.center, center, tempScratch)) + bs.radius;
    ...
    return new GeometryAttribute.Geometry({
      ...
      boundingSphere: defaultValue.defined(center) ? new Transforms.BoundingSphere(center, radius) : undefined
    });
  }
  ...
  var normal = new Matrix3.Cartesian3();
  var v0 = new Matrix3.Cartesian3();
  var v1 = new Matrix3.Cartesian3();
  var v2 = new Matrix3.Cartesian3();
    ...
    for (i = 0; i < numVertices; i++) {
      ...
      if (vertexNormalData.count > 0) {
        for (j = 0; j < vertexNormalData.count; j++) {
          Matrix3.Cartesian3.add(normal, normalsPerTriangle[normalIndices[vertexNormalData.indexOffset + j]], normal);
        }

        // We can run into an issue where a vertex is used with 2 primitives that have opposite winding order.
        if (Matrix3.Cartesian3.equalsEpsilon(Matrix3.Cartesian3.ZERO, normal, Math$1.CesiumMath.EPSILON10)) {
          Matrix3.Cartesian3.clone(normalsPerTriangle[normalIndices[vertexNormalData.indexOffset]], normal);
        }
      }
  ...
  var normalScale = new Matrix3.Cartesian3();
  var tScratch = new Matrix3.Cartesian3();
  ...
  GeometryPipeline.computeTangentAndBitangent = function (geometry) {
    ...
    for (i = 0; i < numVertices; i++) {
      ...
      i13 = i03 + 1;
      i23 = i03 + 2;
      var n = Matrix3.Cartesian3.fromArray(normals, i03, normalScratch);
      var t = Matrix3.Cartesian3.fromArray(tan1, i03, tScratch);
      var scalar = Matrix3.Cartesian3.dot(n, t);
  ...
  var toEncode1 = new Matrix3.Cartesian3();
  var toEncode2 = new Matrix3.Cartesian3();
  var toEncode3 = new Matrix3.Cartesian3();
  ...
  var c3 = new Matrix3.Cartesian3();
  function getXZIntersectionOffsetPoints(p, p1, u1, v1) {
    Matrix3.Cartesian3.add(p, Matrix3.Cartesian3.multiplyByScalar(Matrix3.Cartesian3.subtract(p1, p, c3), p.y / (p.y - p1.y), c3), u1);
    Matrix3.Cartesian3.clone(u1, v1);
    offsetPointFromXZPlane(u1, true);
    offsetPointFromXZPlane(v1, false);
  }
  var u1 = new Matrix3.Cartesian3();
  var u2 = new Matrix3.Cartesian3();
  var q1 = new Matrix3.Cartesian3();
  var q2 = new Matrix3.Cartesian3();
  ...
  var interpolateAndPackCartesian4 = generateBarycentricInterpolateFunction(Matrix2.Cartesian4, 4);
  var interpolateAndPackCartesian3 = generateBarycentricInterpolateFunction(Matrix3.Cartesian3, 3);
  var interpolateAndPackCartesian2 = generateBarycentricInterpolateFunction(Matrix2.Cartesian2, 2);
  var interpolateAndPackBoolean = function interpolateAndPackBoolean(i0, i1, i2, coords, sourceValues, currentValues, insertedIndex) {
  ...
  var p0Scratch = new Matrix3.Cartesian3();
  var p1Scratch = new Matrix3.Cartesian3();
  var p2Scratch = new Matrix3.Cartesian3();
  var barycentricScratch = new Matrix3.Cartesian3();
  function computeTriangleAttributes(i0, i1, i2, point, positions, normals, tangents, bitangents, texCoords, extrudeDirections, applyOffset, currentAttributes, customAttributeNames, customAttributesLength, allAttributes, insertedIndex) {
    ...
    var p0 = Matrix3.Cartesian3.fromArray(positions, i0 * 3, p0Scratch);
    var p1 = Matrix3.Cartesian3.fromArray(positions, i1 * 3, p1Scratch);
    var p2 = Matrix3.Cartesian3.fromArray(positions, i2 * 3, p2Scratch);
    ...
    if (defaultValue.defined(extrudeDirections)) {
      var d0 = Matrix3.Cartesian3.fromArray(extrudeDirections, i0 * 3, p0Scratch);
      var d1 = Matrix3.Cartesian3.fromArray(extrudeDirections, i1 * 3, p1Scratch);
      var d2 = Matrix3.Cartesian3.fromArray(extrudeDirections, i2 * 3, p2Scratch);
      ...
      var direction;
      if (!Matrix3.Cartesian3.equals(d0, Matrix3.Cartesian3.ZERO) || !Matrix3.Cartesian3.equals(d1, Matrix3.Cartesian3.ZERO) || !Matrix3.Cartesian3.equals(d2, Matrix3.Cartesian3.ZERO)) {
      ...
      Matrix3.Cartesian3.pack(direction, currentAttributes.extrudeDirection.values, insertedIndex * 3);
    }
  ...
  function splitLongitudeTriangles(instance) {
    ...
    for (i = 0; i < len; i += 3) {
      ...
      var i1 = indices[i + 1];
      var i2 = indices[i + 2];
      var p0 = Matrix3.Cartesian3.fromArray(positions, i0 * 3);
      var p1 = Matrix3.Cartesian3.fromArray(positions, i1 * 3);
      var p2 = Matrix3.Cartesian3.fromArray(positions, i2 * 3);
  ...
  var xzPlane = Plane.Plane.fromPointNormal(Matrix3.Cartesian3.ZERO, Matrix3.Cartesian3.UNIT_Y);
  var offsetScratch = new Matrix3.Cartesian3();
  var offsetPointScratch = new Matrix3.Cartesian3();
  ...
  function splitLongitudeLines(instance) {
    ...
    for (i = 0; i < length; i += 2) {
      ...
      if (defaultValue.defined(intersection)) {
        ...
        var offset = Matrix3.Cartesian3.multiplyByScalar(Matrix3.Cartesian3.UNIT_Y, 5.0 * Math$1.CesiumMath.EPSILON9, offsetScratch);
        if (p0.y < 0.0) {
        ...
        var offsetPoint = Matrix3.Cartesian3.add(intersection, offset, offsetPointScratch);
        ...
        var currentAttributes = void 0;
        var currentIndices = void 0;
        var currentIndexMap = void 0;
        if (p0.y < 0.0) {
          currentAttributes = westGeometry.attributes;
          currentIndices = westGeometry.indices;
          currentIndexMap = westGeometryIndexMap;
  ...
  var cartesian3Scratch0 = new Matrix3.Cartesian3();
  var cartesian3Scratch2 = new Matrix3.Cartesian3();
  var cartesian3Scratch3 = new Matrix3.Cartesian3();
  var cartesian3Scratch4 = new Matrix3.Cartesian3();
  var cartesian3Scratch5 = new Matrix3.Cartesian3();
  var cartesian3Scratch6 = new Matrix3.Cartesian3();
  ...
  function updateAdjacencyAfterSplit(geometry) {
    ...
    for (var j = 0; j < length; j += 3) {
      var position = Matrix3.Cartesian3.unpack(positions, j, cartesian3Scratch0);
      if (position.x > 0.0) {
        continue;
      }
      var prevPosition = Matrix3.Cartesian3.unpack(prevPositions, j, cartesian3Scratch2);
      ...
      var nextPosition = Matrix3.Cartesian3.unpack(nextPositions, j, cartesian3Scratch3);
  ...
  function splitLongitudePolyline(instance) {
    ...
    for (i = 0; i < length; i += 4) {
      var i0 = i;
      var i2 = i + 2;
      var p0 = Matrix3.Cartesian3.fromArray(positions, i0 * 3, cartesian3Scratch0);
      var p2 = Matrix3.Cartesian3.fromArray(positions, i2 * 3, cartesian3Scratch2);
      ...
      if (defaultValue.defined(intersection)) {
        ...
        // move point on the xz-plane slightly away from the plane
        var offset = Matrix3.Cartesian3.multiplyByScalar(Matrix3.Cartesian3.UNIT_Y, offsetScalar, cartesian3Scratch5);
        if (p0.y < 0.0) {
          Matrix3.Cartesian3.negate(offset, offset);
          p0Attributes = westGeometry.attributes;
          p0Indices = westGeometry.indices;
        ...
        var offsetPoint = Matrix3.Cartesian3.add(intersection, offset, cartesian3Scratch6);
        ...
        var ew0 = Matrix2.Cartesian2.fromArray(expandAndWidths, i0 * 2, cartesian2Scratch0);
        var width = Math.abs(ew0.y);
        p0Attributes.expandAndWidth.values.push(-1, width, 1, width);
        p0Attributes.expandAndWidth.values.push(-1, -width, 1, -width);
        p2Attributes.expandAndWidth.values.push(-1, width, 1, width);
        p2Attributes.expandAndWidth.values.push(-1, -width, 1, -width);
        var t = Matrix3.Cartesian3.magnitudeSquared(Matrix3.Cartesian3.subtract(intersection, p0, cartesian3Scratch3));
        t /= Matrix3.Cartesian3.magnitudeSquared(Matrix3.Cartesian3.subtract(p2, p0, cartesian3Scratch3));
        ...
        if (defaultValue.defined(texCoords)) {
          ...
          var s3 = Matrix2.Cartesian2.fromArray(texCoords, (i + 3) * 2, cartesian2Scratch1);
