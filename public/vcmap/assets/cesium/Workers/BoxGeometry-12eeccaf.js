define(['exports', './Transforms-40229881', './Matrix3-315394f6', './Check-666ab1a0', './ComponentDatatype-f7b11d02', './defaultValue-0a909f67', './GeometryAttribute-7d6f1732', './GeometryAttributes-f06a2792', './GeometryOffsetAttribute-04332ce7', './VertexFormat-6b480673'], function (exports, Transforms, Matrix3, Check, ComponentDatatype, defaultValue, GeometryAttribute, GeometryAttributes, GeometryOffsetAttribute, VertexFormat) {
  'use strict';

  var diffScratch = new Matrix3.Cartesian3();
  ...
  BoxGeometry.fromDimensions = function (options) {
    ...
    var corner = Matrix3.Cartesian3.multiplyByScalar(dimensions, 0.5, new Matrix3.Cartesian3());
   ...
   * @type {Number}
   */
  BoxGeometry.packedLength = 2 * Matrix3.Cartesian3.packedLength + VertexFormat.VertexFormat.packedLength + 1;
  ...
  BoxGeometry.pack = function (value, array, startingIndex) {
    ...
    VertexFormat.VertexFormat.pack(value._vertexFormat, array, startingIndex + 2 * Matrix3.Cartesian3.packedLength);
    array[startingIndex + 2 * Matrix3.Cartesian3.packedLength + VertexFormat.VertexFormat.packedLength] = defaultValue.defaultValue(value._offsetAttribute, -1);
    return array;
  };
  var scratchMin = new Matrix3.Cartesian3();
  var scratchMax = new Matrix3.Cartesian3();
  ...
  BoxGeometry.unpack = function (array, startingIndex, result) {
    ...
    startingIndex = defaultValue.defaultValue(startingIndex, 0);
    var min = Matrix3.Cartesian3.unpack(array, startingIndex, scratchMin);
    var max = Matrix3.Cartesian3.unpack(array, startingIndex + Matrix3.Cartesian3.packedLength, scratchMax);
    var vertexFormat = VertexFormat.VertexFormat.unpack(array, startingIndex + 2 * Matrix3.Cartesian3.packedLength, scratchVertexFormat);
    var offsetAttribute = array[startingIndex + 2 * Matrix3.Cartesian3.packedLength + VertexFormat.VertexFormat.packedLength];
  ...
  BoxGeometry.createGeometry = function (boxGeometry) {
    ...
    var diff = Matrix3.Cartesian3.subtract(max, min, diffScratch);
    var radius = Matrix3.Cartesian3.magnitude(diff) * 0.5;
