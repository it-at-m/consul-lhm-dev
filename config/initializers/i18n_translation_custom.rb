  ...
  module Helpers
    module TranslationHelper
      ...
      def t(key, options = {})
        ...
        if Current.i18n_content_translations.nil?
          Current.i18n_content_translations = I18nContent.translations_hash(current_locale) || {}
        end

        translation = Current.i18n_content_translations[key]
