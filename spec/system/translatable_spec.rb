...
describe "Public area translatable records" do
  ...
  context "New records" do
    xscenario "Add only single translation at once" do
    ...
    xscenario "Add single translation maintains introduced field values" do
    ...
    xscenario "Add multiple translations at once" do
    ...
    xscenario "Add only single translation at once not having the current locale" do
      visit new_proposal_path
    ...
    xscenario "Add a translation for a locale with non-underscored name" do
      budget = create(:budget_heading, name: "Everywhere").group.budget
    ...
    xscenario "Add an invalid translation" do
      visit new_debate_path
    ...
    xscenario "Shows errors when submiting without any active translations" do
      budget = create(:budget_heading, name: "Everywhere").group.budget
  ...
  context "Globalize javascript interface" do
    xscenario "Highlight current locale" do
      visit new_debate_path

      expect_to_have_language_selected "English"
    end

    xscenario "Highlight new locale added" do
      visit new_proposal_path
    ...
    xscenario "Select a locale and add it to the form" do
    ...
    xscenario "Remove a translation" do
      visit new_budget_investment_path(create(:budget))
    ...
    context "Languages in use" do
      xscenario "Show default description" do
        visit new_debate_path

        expect(page).to have_content "1 language in use"
      end

      xscenario "Increase description count after add new language" do
        visit new_proposal_path
      ...
      xscenario "Decrease description count after remove a language" do
        visit new_proposal_path
    ...
    context "When translation interface feature setting" do
      xscenario "Is enabled translation interface should be rendered" do
        visit new_budget_investment_path(create(:budget))
  ...
  context "Existing records" do
    ...
    context "Update a translation" do
      ...
      context "Update a translation with invalid data" do
        ...
        xscenario "Show validation errors" do
