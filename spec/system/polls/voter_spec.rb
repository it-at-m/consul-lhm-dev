...
describe "Voter" do
  context "Origin", :with_frozen_time do
    ...
    xscenario "Voting via web - Standard" do
    ...
    xscenario "Voting via web as unverified user" do
    ...
    xcontext "The person has decided not to vote at this time" do
    ...
    xcontext "Trying to vote the same poll in booth and web" do
      let!(:user) { create(:user, :in_census) }

      xscenario "Trying to vote in web and then in booth" do
        login_as user
      ...
      xscenario "Trying to vote in booth and then in web" do
        login_through_form_as_officer(officer.user)
      ...
      xscenario "Trying to vote in web again" do
        login_as user
        vote_for_poll_via_web(poll, question, answer_yes.title)
        expect(Poll::Voter.count).to eq(1)
    ...
    xscenario "Voting in poll and then verifiying account" do
      user = create(:user)
