...
#     xit "shows the text body for this version" do
...
#     xit "shows an unpublished version to admins" do
...
#     xit "switches to another version without js", :no_js do
#       visit legislation_process_draft_version_path(process, original)
#       expect(page).to have_content("Original version")
...
#     xit "switches to another version with js" do
#       visit legislation_process_draft_version_path(process, original)
#       expect(page).to have_content("Original version")
...
#       xit "does not show the comments panel" do
...
#     xit "shows the changes for this version" do
